...
export const dict = {
  ...
  "dialog.provider.tag.apiKey": "API 密钥",
  "dialog.provider.mimo.note": "优先使用 MiMo Auto；需要时也可以配置 MiMo API",
  "dialog.provider.mimo.tagline": "MiMo 原生代码模型",
  "dialog.provider.xiaomi.note": "使用你的 MiMo API 密钥连接完整 MiMo 提供商。",
  "dialog.provider.xiaomi.tagline": "连接 MiMo API 密钥",
  "dialog.provider.deepseek.note": "填写 DeepSeek API 密钥即可使用 DeepSeek Chat/Reasoner 等模型",
  "dialog.provider.kimi.note": "填写 Kimi API 密钥即可使用 Moonshot/Kimi 模型",
  "dialog.provider.zhipu.note": "填写智谱 API 密钥即可使用 GLM 系列模型",
  "dialog.provider.alibaba.note": "填写阿里云百炼 API 密钥即可使用 Qwen/千问系列模型",
  "dialog.provider.bytedance.note": "填写火山方舟 API 密钥即可使用豆包系列模型",
  ...
  "dialog.model.showOlder": "显示旧模型",
  "dialog.model.hideOlder": "隐藏旧模型",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 并输入以下代码，以连接你的帐户并在 MiMo Code 中使用 {{provider}} 模型。",
  ...
  "prompt.executionTarget.tooltip": "选择用哪里执行这条命令",
  ...
  "prompt.toast.modelAgentRequired.description": "发送提示前，请配置 MiMo API 密钥或选择 MiMo Auto。",
  "prompt.toast.modelAgentRequired.action": "配置 API 密钥",
  "prompt.toast.mimoKeyRequired.title": "配置 MiMo API 密钥",
  "prompt.toast.mimoKeyRequired.description": "当前 MiMo 提供商需要先配置 API 密钥才能发送提示。",
  "prompt.toast.mimoKeyRequired.action": "添加 API 密钥",
  ...
  "prompt.toast.externalCommandEmpty.description": "使用外部 CLI 前，请先输入命令。",
  ...
  "settings.agents.title": "编程 Agent",
  "settings.agents.description": "查看本机已安装的编程 Agent CLI，并检查它们是否为最新版本。",
  "settings.agents.action.refresh": "刷新",
  "settings.agents.action.refreshing": "刷新中...",
  "settings.agents.action.install": "安装",
  "settings.agents.action.update": "更新",
  "settings.agents.action.updating": "更新中...",
  "settings.agents.action.installGuide": "安装说明",
  "settings.agents.status.notInstalled": "未安装",
  "settings.agents.status.latest": "最新版本",
  "settings.agents.status.updateAvailable": "可更新",
  "settings.agents.status.unknown": "未知",
  "settings.agents.version.notInstalled": "这台机器上尚未安装",
  "settings.agents.version.latest": "最新版本：{{version}}",
  "settings.agents.version.outdated": "已安装：{{current}} · 最新：{{latest}}",
  "settings.agents.version.current": "已安装：{{version}}",
  "settings.agents.version.unknown": "暂时无法获取版本状态",
  "settings.agents.toast.refreshFailed.title": "无法刷新编程 Agent",
  "settings.agents.toast.updateSucceeded.title": "{{name}} 已更新",
  "settings.agents.toast.updateFailed.title": "无法更新 {{name}}",
  ...
  "settings.general.section.appearance.description": "主题、配色方案和界面字体。",
  "settings.general.section.advanced": "高级",
  "settings.general.section.advanced.description": "调整桌面界面和标题栏控件。",
  "settings.general.section.basic": "基础",
  "settings.general.section.basic.description": "语言、快捷键、权限和时间线默认行为。",
  "settings.general.section.notifications": "系统通知",
  "settings.general.section.notifications.description": "选择 MiMo Code 可以发送哪些桌面通知。",
  "settings.general.section.updates": "更新",
  "settings.general.section.updates.description": "控制更新检查和发行说明提示。",
  "settings.general.section.sounds": "音效",
  "settings.general.section.sounds.description": "选择 Agent、权限和错误事件使用的提示音。",
  "settings.general.section.feed": "动态",
  "settings.general.section.display": "显示",
  "settings.general.section.display.description": "平台相关的显示行为。",
  "settings.general.row.language.title": "语言",
  "settings.general.row.language.description": "更改 MiMo Code 的显示语言",
  "settings.general.row.shortcuts.description": "打开完整的键盘快捷键编辑器",
  ...
  "settings.providers.description": "配置密钥、端点和模型检测。",
  "settings.providers.section.providers": "供应商",
  "settings.providers.section.customProviders": "供应商",
  "settings.providers.section.credentials": "供应商凭据",
  "settings.providers.section.models": "模型 ID",
  ...
  "settings.providers.custom.add": "添加自定义提供商",
  "settings.providers.custom.addShort": "自定义",
  "settings.providers.apiKey.label": "{{provider}} API 密钥",
  "settings.providers.apiKey.placeholder": "留空则保留已保存密钥",
  "settings.providers.apiKey.description": "密钥仅保存在本地，并且只会在填写此项时更新。",
  "settings.providers.apiKey.get": "前往获取",
  "settings.providers.apiKey.show": "显示密钥",
  "settings.providers.apiKey.hide": "隐藏密钥",
  "settings.providers.url.anthropic.label": "Anthropic 接口地址",
  "settings.providers.url.openai.label": "OpenAI 接口地址",
  "settings.providers.status.enabled": "已启用",
  "settings.providers.status.disabled": "已禁用",
  "settings.providers.status.connected": "供应商接口已连通",
  "settings.providers.status.disconnected": "供应商接口未连通",
  "settings.providers.test.action": "测试",
  "settings.providers.test.testing": "测试中...",
  "settings.providers.test.available": "可用：{{agents}}",
  "settings.providers.test.unavailable": "不可用：{{agents}}",
  "settings.providers.test.none": "无",
  "settings.providers.test.reason": "原因：{{reason}}",
  "settings.providers.test.separator": "，",
  "settings.providers.models.loading": "正在拉取最新模型列表...",
  "settings.providers.models.toggle": "启用或关闭这个模型",
  "settings.providers.models.remove": "删除模型",
  "settings.providers.models.custom": "自定义",
  "settings.providers.models.older": "旧模型",
  "settings.providers.models.olderSection": "旧模型",
  "settings.providers.models.deprecated": "已弃用",
  "settings.providers.models.add.id": "模型 ID",
  "settings.providers.models.add.idPlaceholder": "model-id",
  "settings.providers.models.add.name": "显示名称",
  "settings.providers.models.add.namePlaceholder": "模型名称",
  "settings.providers.models.add.action": "添加",
  "settings.providers.models.releaseUnknown": "无发布日期",
  "settings.providers.models.status.connected": "模型已连通",
  "settings.providers.models.status.disconnected": "模型未连通",
  "settings.providers.mimo.authorize": "授权 MIMO",
  "settings.providers.save.success.title": "{{provider}} 已保存",
  "settings.providers.save.success.description": "提供商设置已更新。",
  ...
  "settings.mcp.description": "管理 MCP 服务器配置，支持通用/Claude CLI/Gemini/Codex/OpenCode 五种来源。",
  "settings.mcp.search.label": "搜索 MCP 服务器",
  "settings.mcp.search.placeholder": "搜索 MCP 服务器...",
  "settings.mcp.empty": "还没有 MCP 服务器",
  "settings.mcp.empty.title": "还没有 MCP 服务器",
  "settings.mcp.empty.description": "添加一个 MCP 服务器，让 Agent 获得额外能力。",
  "settings.mcp.status.unknown": "未启动",
  "settings.mcp.action.add": "添加 MCP 服务器",
  "settings.mcp.action.new": "新建 MCP 服务器",
  "settings.mcp.action.edit": "编辑",
  "settings.mcp.action.delete": "删除 MCP 服务器",
  "settings.mcp.source.all": "通用",
  ...
  "settings.mcp.addSoon.title": "MCP 服务器编辑器下一步接入",
  "settings.mcp.addSoon.description": "当前概览页已按目标设计重做，新增/编辑流程会从这里打开。",
  "settings.mcp.type.local": "本地",
  "settings.mcp.type.remote": "远程",
  "settings.mcp.field.name.label": "服务器名称",
  "settings.mcp.field.name.placeholder": "github",
  "settings.mcp.field.enabled.label": "启动",
  "settings.mcp.field.enabled.description": "启动时启用",
  "settings.mcp.field.type.label": "传输方式",
  "settings.mcp.field.command.label": "命令",
  "settings.mcp.field.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.field.command.description": "参数里有空格时请使用引号。",
  "settings.mcp.field.url.label": "服务器 URL",
  "settings.mcp.field.url.placeholder": "https://example.com/mcp",
  "settings.mcp.field.environment.label": "环境变量",
  "settings.mcp.field.environment.placeholder": "GITHUB_TOKEN=...",
  "settings.mcp.field.headers.label": "请求头",
  "settings.mcp.field.headers.placeholder": "Authorization=Bearer ...",
  "settings.mcp.field.keyValues.description": "每行填写一个 KEY=value。",
  "settings.mcp.field.timeout.label": "超时",
  "settings.mcp.field.timeout.placeholder": "5000",
  "settings.mcp.field.oauth.label": "关闭 OAuth 自动检测",
  "settings.mcp.field.oauth.description": "远程服务器不支持 OAuth discovery 时使用此项。",
  "settings.mcp.error.nameRequired": "请输入服务器名称。",
  "settings.mcp.error.nameExists": "已存在同名服务器。",
  "settings.mcp.error.commandRequired": "请输入命令。",
  "settings.mcp.error.commandQuotes": "命令里有未闭合的引号。",
  "settings.mcp.error.url": "请输入有效 URL。",
  "settings.mcp.error.timeout": "超时必须是正数。",
  "settings.mcp.error.keyValue": "无效的 KEY=value 行：{{line}}",
  "settings.mcp.toast.saved.title": "{{name}} 已保存",
  "settings.mcp.toast.saved.description": "MCP 服务器配置已更新。",
  "settings.mcp.toast.deleted.title": "{{name}} 已删除",
  "settings.mcp.toast.deleted.description": "MCP 服务器配置已移除。",
