export const dict = {
  ...
  "dialog.provider.tag.apiKey": "API key",
  "dialog.provider.mimo.note": "MiMo Auto is available first, with optional MiMo API configuration when needed",
  "dialog.provider.mimo.tagline": "MiMo-native coding models",
  "dialog.provider.xiaomi.note": "Use your MiMo API key for the full MiMo provider.",
  "dialog.provider.xiaomi.tagline": "Connect MiMo API key",
  "dialog.provider.deepseek.note": "Enter a DeepSeek API key to use DeepSeek Chat, Reasoner, and related models",
  "dialog.provider.kimi.note": "Enter a Kimi API key to use Moonshot/Kimi models",
  "dialog.provider.zhipu.note": "Enter a Zhipu API key to use GLM models",
  "dialog.provider.alibaba.note": "Enter an Alibaba Cloud Model Studio API key to use Qwen models",
  "dialog.provider.bytedance.note": "Enter a Volcano Ark API key to use ByteDance Doubao models",
  ...
  "dialog.model.showOlder": "Show older models",
  "dialog.model.hideOlder": "Hide older models",

  "dialog.model.unpaid.freeModels.title": "Free models provided by MiMo",
  ...
  "provider.custom.models.openaiBaseURL.label": "OpenAI API URL",
  "provider.custom.models.openaiBaseURL.placeholder": "OpenAI API URL",
  "provider.custom.models.anthropicBaseURL.label": "Anthropic API URL",
  "provider.custom.models.anthropicBaseURL.placeholder": "Anthropic API URL",
  ...
  "prompt.executionTarget.tooltip": "Choose where to run this command",
  "prompt.executionTarget.mimo": "MiMo Code",
  "prompt.executionTarget.claude": "Claude Code",
  "prompt.executionTarget.codex": "Codex CLI",
  "prompt.executionTarget.opencode": "OpenCode",
  ...
  "prompt.toast.modelAgentRequired.description":
    "Configure a MiMo API key or choose MiMo Auto before sending a prompt.",
  "prompt.toast.modelAgentRequired.action": "Configure API key",
  "prompt.toast.mimoKeyRequired.title": "Configure MiMo API key",
  "prompt.toast.mimoKeyRequired.description": "This MiMo provider needs an API key before it can send prompts.",
  "prompt.toast.mimoKeyRequired.action": "Add API key",
  ...
  "prompt.toast.externalCommandEmpty.description": "Enter a command before using an external CLI.",
  ...
  "settings.agents.description":
    "Manage locally installed programming agent CLIs and check whether they are up to date.",
  "settings.agents.action.refresh": "Refresh",
  "settings.agents.action.refreshing": "Refreshing...",
  "settings.agents.action.install": "Install",
  "settings.agents.action.update": "Update",
  "settings.agents.action.updating": "Updating...",
  "settings.agents.action.installGuide": "Guide",
  "settings.agents.status.notInstalled": "Not installed",
  "settings.agents.status.latest": "Latest",
  "settings.agents.status.updateAvailable": "Update available",
  "settings.agents.status.unknown": "Unknown",
  "settings.agents.version.notInstalled": "Not installed on this machine",
  "settings.agents.version.latest": "Latest version: {{version}}",
  "settings.agents.version.outdated": "Installed: {{current}} · Latest: {{latest}}",
  "settings.agents.version.current": "Installed: {{version}}",
  "settings.agents.version.unknown": "Version status unavailable",
  "settings.agents.toast.refreshFailed.title": "Could not refresh agents",
  "settings.agents.toast.updateSucceeded.title": "{{name}} updated",
  "settings.agents.toast.updateFailed.title": "Could not update {{name}}",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Run the MiMo Code server inside WSL on Windows.",

  "settings.general.section.appearance": "Appearance",
  "settings.general.section.appearance.description": "Theme, color scheme, and interface fonts.",
  "settings.general.section.advanced": "Advanced",
  "settings.general.section.advanced.description": "Tune optional desktop surfaces and title bar controls.",
  "settings.general.section.basic": "Basics",
  "settings.general.section.basic.description": "Language, shortcuts, permissions, and timeline defaults.",
  "settings.general.section.notifications": "System notifications",
  "settings.general.section.notifications.description": "Choose which desktop notifications MiMo Code can send.",
  "settings.general.section.updates": "Updates",
  "settings.general.section.updates.description": "Control update checks and release note prompts.",
  "settings.general.section.sounds": "Sound effects",
  "settings.general.section.sounds.description": "Pick the sounds used for agent, permission, and error events.",
  "settings.general.section.feed": "Feed",
  "settings.general.section.display": "Display",
  "settings.general.section.display.description": "Platform-specific display behavior.",

  "settings.general.row.language.title": "Language",
  "settings.general.row.language.description": "Change the display language for MiMo Code",
  "settings.general.row.shortcuts.description": "Open the full keyboard shortcut editor",
  ...
  "settings.providers.description": "Configure keys, endpoints, and model checks.",
  "settings.providers.section.providers": "Providers",
  "settings.providers.section.customProviders": "Providers",
  "settings.providers.section.credentials": "Provider credentials",
  "settings.providers.section.models": "Model IDs",
  ...
  "settings.providers.custom.add": "Add custom provider",
  "settings.providers.custom.addShort": "Custom",
  "settings.providers.apiKey.label": "{{provider}} API key",
  "settings.providers.apiKey.placeholder": "Leave blank to keep saved key",
  "settings.providers.apiKey.description": "Keys are stored locally and are only updated when this field is filled.",
  "settings.providers.apiKey.get": "Get key",
  "settings.providers.apiKey.show": "Show API key",
  "settings.providers.apiKey.hide": "Hide API key",
  "settings.providers.url.anthropic.label": "Anthropic API URL",
  "settings.providers.url.openai.label": "OpenAI API URL",
  "settings.providers.status.enabled": "Enabled",
  "settings.providers.status.disabled": "Disabled",
  "settings.providers.status.connected": "Provider connected",
  "settings.providers.status.disconnected": "Provider not connected",
  "settings.providers.test.action": "Test",
  "settings.providers.test.testing": "Testing...",
  "settings.providers.test.available": "Available: {{agents}}",
  "settings.providers.test.unavailable": "Unavailable: {{agents}}",
  "settings.providers.test.none": "none",
  "settings.providers.test.reason": "Reason: {{reason}}",
  "settings.providers.test.separator": ", ",
  "settings.providers.models.loading": "Loading latest model list...",
  "settings.providers.models.toggle": "Enable or disable this model",
  "settings.providers.models.remove": "Remove model",
  "settings.providers.models.custom": "Custom",
  "settings.providers.models.older": "Older",
  "settings.providers.models.olderSection": "Older models",
  "settings.providers.models.deprecated": "Deprecated",
  "settings.providers.models.add.id": "Model ID",
  "settings.providers.models.add.idPlaceholder": "model-id",
  "settings.providers.models.add.name": "Display name",
  "settings.providers.models.add.namePlaceholder": "Model name",
  "settings.providers.models.add.action": "Add",
  "settings.providers.models.releaseUnknown": "No release date",
  "settings.providers.models.status.connected": "Model connected",
  "settings.providers.models.status.disconnected": "Model not connected",
  "settings.providers.mimo.authorize": "Authorize MIMO",
  "settings.providers.save.success.title": "{{provider}} saved",
  "settings.providers.save.success.description": "Provider settings have been updated.",
  ...
  "settings.mcp.description":
    "Manage MCP server configuration with shared, Claude CLI, Gemini, Codex, and OpenCode sources.",
  "settings.mcp.search.label": "Search MCP servers",
  ...
  "settings.mcp.empty.description": "Add an MCP server to give the agent extra capabilities.",
  "settings.mcp.status.unknown": "not started",
  "settings.mcp.action.add": "Add MCP server",
  "settings.mcp.action.new": "New MCP server",
  "settings.mcp.action.edit": "Edit",
  "settings.mcp.action.delete": "Delete MCP server",
  "settings.mcp.source.all": "Shared",
  "settings.mcp.source.zcode": "ZCode Agent",
  "settings.mcp.source.claude": "Claude CLI",
  "settings.mcp.source.codex": "Codex CLI",
  "settings.mcp.source.gemini": "Gemini CLI",
  "settings.mcp.source.opencode": "OpenCode CLI",
  "settings.mcp.addSoon.title": "MCP server editor is next",
  "settings.mcp.addSoon.description":
    "The overview now matches the target design; the add/edit flow will open from here.",
  "settings.mcp.type.local": "Local",
  "settings.mcp.type.remote": "Remote",
  "settings.mcp.field.name.label": "Server name",
  "settings.mcp.field.name.placeholder": "github",
  "settings.mcp.field.enabled.label": "Startup",
  "settings.mcp.field.enabled.description": "Enable on startup",
  "settings.mcp.field.type.label": "Transport",
  "settings.mcp.field.command.label": "Command",
  "settings.mcp.field.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem",
  "settings.mcp.field.command.description": "Use quotes for arguments that contain spaces.",
  "settings.mcp.field.url.label": "Server URL",
  "settings.mcp.field.url.placeholder": "https://example.com/mcp",
  "settings.mcp.field.environment.label": "Environment variables",
  "settings.mcp.field.environment.placeholder": "GITHUB_TOKEN=...",
  "settings.mcp.field.headers.label": "Headers",
  "settings.mcp.field.headers.placeholder": "Authorization=Bearer ...",
  "settings.mcp.field.keyValues.description": "One KEY=value pair per line.",
  "settings.mcp.field.timeout.label": "Timeout",
  "settings.mcp.field.timeout.placeholder": "5000",
  "settings.mcp.field.oauth.label": "Disable OAuth auto-detection",
  "settings.mcp.field.oauth.description": "Use this for remote servers that do not support OAuth discovery.",
  "settings.mcp.error.nameRequired": "Enter a server name.",
  "settings.mcp.error.nameExists": "A server with this name already exists.",
  "settings.mcp.error.commandRequired": "Enter a command.",
  "settings.mcp.error.commandQuotes": "Command has an unclosed quote.",
  "settings.mcp.error.url": "Enter a valid URL.",
  "settings.mcp.error.timeout": "Timeout must be a positive number.",
  "settings.mcp.error.keyValue": "Invalid KEY=value line: {{line}}",
  "settings.mcp.toast.saved.title": "{{name}} saved",
  "settings.mcp.toast.saved.description": "MCP server configuration has been updated.",
  "settings.mcp.toast.deleted.title": "{{name}} deleted",
  "settings.mcp.toast.deleted.description": "MCP server configuration has been removed.",
