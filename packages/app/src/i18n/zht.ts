...
export const dict = {
  ...
  "settings.agents.title": "程式 Agent",
  "settings.agents.description": "查看本機已安裝的程式 Agent CLI，並檢查它們是否為最新版本。",
  "settings.agents.action.refresh": "重新整理",
  "settings.agents.action.refreshing": "重新整理中...",
  "settings.agents.action.install": "安裝",
  "settings.agents.action.update": "更新",
  "settings.agents.action.updating": "更新中...",
  "settings.agents.action.installGuide": "安裝說明",
  "settings.agents.status.notInstalled": "未安裝",
  "settings.agents.status.latest": "最新版本",
  "settings.agents.status.updateAvailable": "可更新",
  "settings.agents.status.unknown": "未知",
  "settings.agents.version.notInstalled": "這台機器上尚未安裝",
  "settings.agents.version.latest": "最新版本：{{version}}",
  "settings.agents.version.outdated": "已安裝：{{current}} · 最新：{{latest}}",
  "settings.agents.version.current": "已安裝：{{version}}",
  "settings.agents.version.unknown": "暫時無法取得版本狀態",
  "settings.agents.toast.refreshFailed.title": "無法重新整理程式 Agent",
  "settings.agents.toast.updateSucceeded.title": "{{name}} 已更新",
  "settings.agents.toast.updateFailed.title": "無法更新 {{name}}",
  ...
  "settings.general.section.appearance.description": "主題、配色方案和介面字型。",
  "settings.general.section.advanced": "進階",
  "settings.general.section.advanced.description": "調整桌面介面和標題列控制項。",
  "settings.general.section.basic": "基本",
  "settings.general.section.basic.description": "語言、快速鍵、權限和時間軸預設行為。",
  "settings.general.section.notifications": "系統通知",
  "settings.general.section.notifications.description": "選擇 MiMo Code 可以傳送哪些桌面通知。",
  "settings.general.section.updates": "更新",
  "settings.general.section.updates.description": "控制更新檢查和發行說明提示。",
  "settings.general.section.sounds": "音效",
  "settings.general.section.sounds.description": "選擇 Agent、權限和錯誤事件使用的提示音。",
  "settings.general.section.feed": "資訊流",
  "settings.general.section.display": "顯示",
  "settings.general.section.display.description": "平台相關的顯示行為。",

  "settings.general.row.language.title": "語言",
  "settings.general.row.language.description": "變更 OpenCode 的顯示語言",
  "settings.general.row.shortcuts.description": "開啟完整的鍵盤快速鍵編輯器",
  ...
  "settings.providers.description": "設定金鑰、端點與模型檢測。",
  "settings.providers.section.providers": "提供者",
  "settings.providers.section.customProviders": "提供者",
  "settings.providers.section.credentials": "提供者憑證",
  ...
  "settings.providers.custom.add": "新增自訂提供者",
  "settings.providers.custom.addShort": "自訂",
  "settings.providers.apiKey.label": "{{provider}} API 金鑰",
  "settings.providers.apiKey.placeholder": "留空則保留已儲存金鑰",
  "settings.providers.apiKey.description": "金鑰僅儲存在本機，且只有填寫此欄位時才會更新。",
  "settings.providers.apiKey.get": "前往取得",
  "settings.providers.url.anthropic.label": "Anthropic URL",
  "settings.providers.url.openai.label": "OpenAI URL",
  "settings.providers.test.action": "測試",
  "settings.providers.test.testing": "測試中...",
  "settings.providers.test.available": "可用：{{agents}}",
  "settings.providers.test.unavailable": "不可用：{{agents}}",
  "settings.providers.test.none": "無",
  "settings.providers.test.reason": "原因：{{reason}}",
  "settings.providers.test.separator": "，",
  "settings.providers.save.success.title": "{{provider}} 已儲存",
  "settings.providers.save.success.description": "提供者設定已更新。",
