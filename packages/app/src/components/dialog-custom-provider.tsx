...
export function DialogCustomProvider(props: Props) {
  ...
  const setModel = (index: number, key: "id" | "name" | "openaiBaseURL" | "anthropicBaseURL", value: string) => {
    batch(() => {
              ...
              {(m, i) => (
                <div class="grid grid-cols-1 sm:grid-cols-[1fr_1fr_auto] gap-2 items-start" data-row={m.row}>
                  ...
                  <TextField
                    ...
                    onChange={(v) => setModel(i(), "openaiBaseURL", v)}
                  ...
                  <TextField
                    ...
                    onChange={(v) => setModel(i(), "anthropicBaseURL", v)}
