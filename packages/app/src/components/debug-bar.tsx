...
export function DebugBar(props: { variant?: "fixed" | "sidebar" } = {}) {
  ...
  return (
    <aside
      ...
      classList={{
        "pointer-events-auto overflow-hidden border border-border-base bg-surface-raised-stronger-non-alpha p-0.5 text-text-strong shadow-[var(--shadow-lg-border-base)]":
          true,
        "fixed bottom-3 right-3 z-50 w-[308px] max-w-[calc(100vw-1.5rem)] rounded-xl sm:bottom-4 sm:right-4 sm:w-[324px]":
          props.variant !== "sidebar",
        "w-full max-w-full rounded-lg": props.variant === "sidebar",
      }}
    >
