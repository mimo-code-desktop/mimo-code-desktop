...
export type ProjectSidebarContext = {
  ...
  projectViewActive: Accessor<boolean>
    ...
    >
      <ContextMenu.Trigger
        ...
        onClick={() => {
          ...
          if (!props.projectViewActive()) {
            props.showProjectView()
            if (!props.current()) props.navigateToProject(props.project.worktree)
            return
          }
...
export const SortableProject = (props: {
  ...
  const current = createMemo(() => props.ctx.currentProject()?.worktree === props.project.worktree)
  const selected = createMemo(() => props.ctx.projectViewActive() && current())
  ...
  const tile = () => (
    <ProjectTile
      ...
      selected={selected}
      current={current}
      projectViewActive={props.ctx.projectViewActive}
      active={active}
      overlay={overlay}
      ...
      showProjectView={props.ctx.showProjectView}
