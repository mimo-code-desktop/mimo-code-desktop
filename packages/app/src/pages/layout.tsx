...
import type { SettingsSection } from "@/components/dialog-settings"

const SettingsContent = lazy(() => import("@/components/dialog-settings").then((x) => ({ default: x.SettingsContent })))
const SettingsNav = lazy(() => import("@/components/dialog-settings").then((x) => ({ default: x.SettingsNav })))
...
export default function Layout(props: ParentProps) {
  ...
  const [state, setState] = createStore({
    ...
    peeked: false,
    mainView: undefined as "settings" | undefined,
  ...
  const projectSidebarCtx: ProjectSidebarContext = {
    currentDir,
    currentProject,
    projectViewActive: () => state.mainView !== "settings",
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      settingsActive={() => state.mainView === "settings"}
      onOpenSettings={openSettings}
      bottomAccessory={import.meta.env.DEV && !mobile ? <DebugBar variant="sidebar" /> : undefined}
      renderPanel={() =>
        state.mainView === "settings" ? (
          <Suspense fallback={<div class="size-full" />}>
            <SettingsNav value={() => state.settingsSection} onChange={(value) => setState("settingsSection", value)} />
          </Suspense>
        ) : mobile ? (
            ...
            >
              <main
                classList={{
                  ...
                  "overflow-y-hidden": state.mainView === "settings",
                }}
              >
