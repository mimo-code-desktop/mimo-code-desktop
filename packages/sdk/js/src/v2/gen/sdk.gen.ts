...
import type {
  ...
  SessionExternalRunErrors,
  SessionExternalRunResponses,
...
export class Session2 extends HeyApiClient {
   ...
   *
   * Run an external coding agent CLI and append its final response to the session.
   */
  public externalRun<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
      directory?: string
      workspace?: string
    ...
    return (options?.client ?? this.client).post<SessionExternalRunResponses, SessionExternalRunErrors, ThrowOnError>({
      url: "/session/{sessionID}/external-run",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
...
export class Provider extends HeyApiClient {
   ...
   *
   * Test a provider model against Claude Code, Codex, MiMo, and OpenCode agent protocols.
   */
      ...
      [
        {
          args: [
            ...
            { in: "body", key: "modelID" },
            { in: "body", key: "apiKey" },
            { in: "body", key: "openaiURL" },
            { in: "body", key: "anthropicURL" },
          ],
        },
      ],
    )
