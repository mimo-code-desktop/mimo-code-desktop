...
export type SessionExternalRunData = {
  body?: {
    messageID?: string
    agent: string
...
export type SessionExternalRunErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type SessionExternalRunError = SessionExternalRunErrors[keyof SessionExternalRunErrors]

export type SessionExternalRunResponses = {
  /**
   * Created external agent response
   */
  200: {
    info: Message
    parts: Array<Part>
...
export type SessionExternalRunResponse = SessionExternalRunResponses[keyof SessionExternalRunResponses]
...
export type ProviderTestResponses = {
  ...
  200: {
    agents: Array<{
      agent: "claude_code" | "codex" | "mimo" | "opencode"
      ok: boolean
      status?: number
      message: string
    }>
