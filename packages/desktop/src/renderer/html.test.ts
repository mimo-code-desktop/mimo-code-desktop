...
/**
 * Packaged Electron windows load renderer HTML via the privileged
 * `mimocode-app://` protocol. Root-relative asset paths like `src="/foo.js"`
 * would resolve from the protocol origin root instead of relative to the
 * current HTML entrypoint.
 *
