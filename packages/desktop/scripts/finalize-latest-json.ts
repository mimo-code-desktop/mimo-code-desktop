...
const releaseId = process.env.MIMOCODE_RELEASE ?? process.env.OPENCODE_RELEASE
if (!releaseId) throw new Error("MIMOCODE_RELEASE is required")

const version = process.env.MIMOCODE_VERSION ?? process.env.OPENCODE_VERSION
...
const macxTarGz = "mimo-code-desktop-mac-x64.app.tar.gz"
const macaTarGz = "mimo-code-desktop-mac-arm64.app.tar.gz"
